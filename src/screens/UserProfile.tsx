  ...
  const supplierRows = [
    {
      name: 'Orders',
      icon: <SVGMembership />,
      navigation: 'CompletedOrdersScreen',
    },
    {name: 'Language', icon: <SVGLanguage />, navigation: 'LanguageScreen'},
    {
      name: 'Membership',
      icon: <SVGMembership />,
    ...
    },
    {
      ...
      navigation: 'PaymentMethodScreen',
    },
    {
      name: 'Business Info',
    ...
    {name: 'Drivers', icon: <SVGMembership />, navigation: 'Driver'},
    {
      name: 'Privacy Policy and Settings',
      icon: <SVGMembership />,
