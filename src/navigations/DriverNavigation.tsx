...
import DriverDashboardORderDetails from 'screens/driver/DriverOrderDetails';
import EditProfileDriver from 'screens/driver/EditProfileDriver';
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        ...
        name="DriverDeliveryDetailScreen"
        component={DriverDashboardORderDetails}
      />
      <Stack.Screen
        options={{
          headerShown: true,
